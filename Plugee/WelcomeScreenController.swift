...
class WelcomeScreenController: UIViewController {
    ...
    var welcomeLabel = LabelTitleConnectionScreen(text: "BIENVENUE")
    ...
    func setupViews() {
        ...
        continueButton.bottomAnchor.constraint(equalTo: copyrightLabel.topAnchor,constant : -30).isActive = true
